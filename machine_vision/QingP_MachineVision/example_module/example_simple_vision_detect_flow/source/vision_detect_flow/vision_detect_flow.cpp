#include "vision_detect_flow.h"

VisionDetectFlow::VisionDetectFlow()
{
...
void VisionDetectFlow::showImage(cv::Mat cvmImage)
{
	if (cvmImage.empty())
	{
...
cv::Mat VisionDetectFlow::detectImage(cv::Mat cvmImage)
{
